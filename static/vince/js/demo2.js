...
// 开关点击效果
$(".kgxuan").click(function(){
  if(!$(this).hasClass("kgxuanwei")){$(this).addClass("kgxuanwei")  
  }else{$(this).removeClass("kgxuanwei")  }});
// 开关点击效果

// 开关点击效果
$(".kgbxuan").click(function(){
  if(!$(this).hasClass("kgbxuanwei")){$(this).addClass("kgbxuanwei");$(".jmktms").css({"display":"block"})  
  }else{$(this).removeClass("kgbxuanwei");$(".jmktms").css({"display":"none"})  }});
// 开关点击效果
...
$(".requthree").css({"top":pageWidth*0.2,"left":pageWidth*0.4})
$("#hotone").hover(
...
$("#hotthree").hover(
function(){$(".requthree").css({"display":"block"});
$(".requthree").hover(function(){
$(".requthree").css({"display":"block"})
},function(){
$(".requthree").css({"display":"none"})})},
function(){$(".requthree").css({"display":"none"})})}
...
//新建
$("#jmkts").click(function(){$('.jmktg').css({'opacity':'0'});$('.jmktmss').css({'display':'block'});
$(".jmktsr").css({'display':'none'});$('.jmktmsl').css({'display':'block'});$('.jmktmsq').css({'display':'block'})})

$("#jmktr").click(function(){$('.jmktg').css({'opacity':'0'});$('.jmktmss').css({'display':'none'});
$(".jmktmsr").css({'display':'block'});$('.jmktmsl').css({'display':'none'});$('.jmktmsq').css({'display':'none'})})

$("#jmktl").click(function(){$('.jmktg').css({'opacity':'0'});$('.jmktmss').css({'display':'none'});
$(".jmktmsr").css({'display':'none'});$('.jmktmsl').css({'display':'block'});$('.jmktmsq').css({'display':'none'})})

$("#jmktq").click(function(){$('.jmktg').css({'opacity':'0'});$('.jmktmss').css({'display':'none'});
$(".jmktmsr").css({'display':'none'});$('.jmktmsl').css({'display':'none'});$('.jmktmsq').css({'display':'block'})})

//var jmktzt = $('#jmktzt').hasClass('kgbxuanwei');
//if (jmktzt) {
//	$(".jmktms").css({"display":"block"})
//} else{
//	$(".jmktms").css({"display":"none"})
//};